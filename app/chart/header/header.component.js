...
var ChartHeaderComponent = (function () {
    ...
    ChartHeaderComponent.prototype.onClick = function (e) {
        console.log(e);
    };
    ChartHeaderComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return ChartHeaderComponent;
}());
exports.ChartHeaderComponent = ChartHeaderComponent;
